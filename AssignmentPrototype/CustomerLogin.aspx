...
<body>
    ...
    <div id="id01" class="modal">
        <form class="modal-content animate" runat="server">
            ...
            <center><h3>Dear Customer, Welcome To The Pika Art Gallery!</h3></center>

            <div class="imgcontainer">
                <asp:Image ID="Image1" ImageUrl="pic/SeekPng.png" runat="server" Style="width: 40%; border-radius: 50%;" />
            ...
            <div class="container" style="background-color: #f1f1f1">
                <span class="psw"><a href="CustomerSignUp.aspx">New User?</a></span>
                <br />
            </div>
        </form>
    </div>
